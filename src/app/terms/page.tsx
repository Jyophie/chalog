  ...
  return (
    <PhoneFrame>
      ...
      <main className="flex flex-1 flex-col px-6 pt-2 pb-12">
        ...
        <Article title="제8조의2 (공개 콘텐츠 및 커뮤니티·신고)">
          <Ol>
            <li>
              이용자는 시음 기록을 ‘공개’로 설정할 수 있으며, 공개된 기록(사진·메모·평점
              등)과 작성자 닉네임·프로필 사진은 비회원을 포함한 모든 이용자에게 노출됩니다.
              공개 설정은 언제든 다시 비공개로 변경할 수 있습니다.
            </li>
            <li>
              공개 기록에는 다른 이용자가 좋아요·댓글·답글을 남길 수 있으며, 작성된 댓글은
              본인 또는 해당 기록 작성자가 삭제할 수 있습니다.
            </li>
            <li>
              이용자는 다음에 해당하는 콘텐츠를 공개하거나 작성해서는 안 됩니다.
              <Ul>
                <li>타인의 권리(저작권·초상권·개인정보 등)를 침해하는 콘텐츠</li>
                <li>욕설·혐오·차별·괴롭힘, 음란·폭력적이거나 불쾌감을 주는 콘텐츠</li>
                <li>스팸·광고·허위 정보 등 서비스 목적에 부합하지 않는 콘텐츠</li>
              </Ul>
            </li>
            <li>
              이용자는 부적절한 공개 기록·댓글을 ‘신고’할 수 있습니다. 운영자는 신고 내용을
              검토하여 해당 콘텐츠를 숨김·삭제하거나 이용을 제한할 수 있습니다.
            </li>
            <li>
              운영자는 신고가 없더라도 제3항에 위반되는 콘텐츠를 사전 통지 없이
              비공개·삭제할 수 있습니다.
            </li>
          </Ol>
        </Article>
